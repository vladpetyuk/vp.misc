...
#' image(as.matrix(1:100), col=turbo.colors(100))
#'
#' ## Random
#' N <- 10
#' set.seed(0)
...
#' image(mat, col=turbo.colors(N^2))
#'
#' ## Airy pattern
...
# Code to create colors based off Turbo from Google.
...
#' @export
#' @describeIn colorschemes Google's(?) turbo color scheme
turbo.colors <- function (n, start = 0, end = 1) {
