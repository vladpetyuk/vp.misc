...
#' for missing values.  There is also a hack of \code{\link[Heatplus]{picketPlot}} that enforce axis labels
#' to be always perpendicular.
#'
#' @param x an object of class \code{annHeatmap}.
#' @param na.color character color of NA values
#' @param widths a numerical vector giving the widths of the sub-plots currently
#'        defined.
