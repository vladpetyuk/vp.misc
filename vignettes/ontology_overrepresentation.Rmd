...
xgobp2 <- enrichGO(gcSample[[6]], universe = unique(unlist((gcSample))),
...
xgocc2 <- enrichGO(gcSample[[6]], universe = unique(unlist((gcSample))),
...
xgomf2 <- enrichGO(gcSample[[6]], universe = unique(unlist((gcSample))),
...
xreac <- enrichPathway(gcSample[[6]], universe = unique(unlist((gcSample))),
...
A different layout
```{r show_fake2}
cnetplot(xfake, vertex.label.cex = 0.5, layout=igraph::layout_with_kk)
```
